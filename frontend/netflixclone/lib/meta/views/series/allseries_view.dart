...
class _MoviesViewState extends State<AllSeriesView> {
  @override
  void initState() {
                                                                ...
                                                                Container(
                                                                    ...
                                                                    child: VerticalDivider(
                                                                        color: Colors
                                                                            .white)),
                                                                Text(
                                                                    "${MoviesData.movies[index].showepisodes.length} Episodes",
                                                                    style:
                                                                        normalText),
                                                              ],
                                                            ),
            ...
            child: TextButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => SeriesView(movie: movie)));
                },
                child: Text(
                  "Watch",
